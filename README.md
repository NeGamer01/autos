...
# Setting Cloudflare bagi yang punya Domain sendiri, kamu bisa cek di folder [image](https://github.com/NeGamer01/autos/tree/master/image) untuk tampilan setting lainnya
<br>
- SSL/TLS : FULL<br>
...
# Pointing
![Pointing](https://raw.githubusercontent.com/NeGamer01/autos/main/image/pointing.png)
...
# Menu
![Service Status](https://raw.githubusercontent.com/NeGamer01/autos/main/image/menu.png)

# Service Status
![Service Status](https://raw.githubusercontent.com/NeGamer01/autos/main/image/service.png)
...
```
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/NeGamer01/autos/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
```
